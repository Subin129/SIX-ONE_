...
<body>
	...
	<div id="page">
					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li class="btn-cta"><a href="#"><span><i
											class="icon-cart"></i></span></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<img src="images/black.jpg" style="width: 100%; height: 100px;" />


<!--  본문 -->
<div class="col-md-3 col-md-offset-1 trainers-entry follow" style="padding-top:30px">  
							<img src="images/black.jpg" style="width: 100%; height: 500px;" />
			...
			<div class="animate-box">
				<div class="trainers-entry">
					<div class="trainer-img"
						style="background-image: url(images/classes-1.jpg); height: 600px"></div>
					<div class="desc">
		...
		<div class="container">
			<div class="row row-pb-md">
				<div class="col-md-3 colorlib-widget">
					<h4>여기부턴 footer에 박아넣을거</h4>
					<p>그러니까 이 밑은 신경쓸 필요가 ㅇ벗다</p>
					<p>
				...
				<div class="col-md-3 colorlib-widget">
					...
					<div class="f-blog">
						...
						<div class="desc">
							<h2>
								<a href="blog.html">Tips for sexy body</a>
							</h2>
							<p class="admin">
				...
				<div class="col-md-3 colorlib-widget">
					...
					<ul class="colorlib-footer-links">
						...
						<li><a href="tel://1234567920"><i class="icon-phone"></i>
								+ 1235 2355 98</a></li>
						<li><a href="mailto:info@yoursite.com"><i
								class="icon-envelope"></i> info@yoursite.com</a></li>
						<li><a href="http://luxehotel.com"><i
								class="icon-location4"></i> yourwebsite.com</a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<p>
								...
								</small><br> <small class="block">Demo Images: <a
					...
					function() {
						...
						if (page < 10) {
							if ($(window).scrollTop() + 800 > ($(document)
								...
								$(".appendd")
										.append(
												'<div class="animate-bos"><div class="trainers-entry"><div class="trainer-img" style="background-image: url(images/classes-'
														+ page
